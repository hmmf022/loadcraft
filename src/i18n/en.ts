...
export const en: TranslationDict = {
  ...
  staging: {
    empty: 'No items staged',
    packStaged: 'Pack Staged',
  ...
  toasts: {
    ...
    stagedItem: 'Item added to staging',
    unstagedItem: 'Item removed from staging',
    repackComplete: 'Repack complete: ${placed} items placed',
    repackPartial: '${placed} placed, ${failed} could not be placed',
